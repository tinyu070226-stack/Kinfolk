class SyncController {
    ...
    async syncNote(noteId, payload) {
        ...
        try {
            ...
            const body = { message: 'Update note ' + noteId, content: content, branch: this.branch };
            if (sha) body.sha = sha;
        ...
        try {
            ...
            for (const file of files) {
                if (file.type === 'file' && file.name.endsWith('.json')) {
                    ...
                    const fetchUrl = file.download_url || file.url;
            ...
            // Remove local notes that were deleted on remote
